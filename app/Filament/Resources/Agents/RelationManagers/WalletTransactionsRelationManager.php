...
/**
 * Read-only ledger view — mirrors Vendor's own
 * WalletTransactionsRelationManager. Wallet balances only ever move
 * through App\Actions\Wallet\* actions, never edited here directly.
 */
        ...
        return $table
            ...
            ->columns([
                ...
                TextColumn::make('vendorOrder.vendor_order_number')
                    ->label('Order')
                    ->placeholder('—'),
                TextColumn::make('agentSettlement.reference')
                    ->label('Settlement')
                    ->placeholder('—'),
